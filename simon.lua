...
btns = {
  ...
  },
  {
    ...
    clicked = "game:restart_level()\ngame.snd = nil\ngame.played = false"
  }
}

for i,b in ipairs(btns) do
  local exbtexoff  = elf.CreateTextureFromFile(b.images[1])
  local exbtexover = elf.CreateTextureFromFile(b.images[2])
  local exbtexon   = elf.CreateTextureFromFile(b.images[3])
